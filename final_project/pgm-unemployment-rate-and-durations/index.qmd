...
#| fig-cap: Overall Unemployment Rate Distributions (2015-2025 statistics)
...
plt.show()
```
By overlaying the smooth PDF curve on top of your data's histogram, we can see the Log-Normal distribution matches the distribution of the actual data. The peak of the PDF align with the peak of the histogram. The spread of the PDF roughly match the spread of the data, including the tail (@fig-histogram-lognorm).

...
with pm.Model(coords=coords) as unemployment_industry_model:
    industry_idx_obs = pm.Data("industry_idx_obs", industry_idx, dims="obs_id")
    # Global Priors 
    ...
    unemployment_obs = pm.Data("unemployment_obs", survey_df_industry['unemployment_status'].values, dims="obs_id")
